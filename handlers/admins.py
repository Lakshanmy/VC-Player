...
async def pause(client: Client, message: Message):
    ...
    await message.reply_text("Cyber Player ~ ⏸ Paused.")
...
async def resume(client: Client, message: Message):
    ...
    await message.reply_text("Cyber Player ~ ▶️ Resumed.")
...
async def stop(client: Client, message: Message):
    ...
    await message.reply_text("Cyber Player ~ ⏹ Stopped streaming.")
...
async def skip(client: Client, message: Message):
    ...
    if sira.is_empty(chat_id):
        ...
        await message.reply_text("Cyber Player ~ ⏩ Skipped the current song.")
...
async def admincache(client, message: Message):
    ...
    await message.reply_text("Cyber Player ~ ❇️ Admin cache refreshed!")
